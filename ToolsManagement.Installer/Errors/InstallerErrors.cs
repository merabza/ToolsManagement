...
public static class InstallerErrors
{
    ...
    public static readonly Error ProjectArchiveFileWasNotDownloaded = new()
    {
        Code = nameof(ProjectArchiveFileWasNotDownloaded), Name = "Project archive file not downloaded"
    };

    public static readonly Error ProjectArchiveFilesNotFoundOnExchangeStorage = new()
    {
    ...
    {
        Code = nameof(CannotUpdateSelf), Name = "Cannot update self"
    };

    public static readonly Error ExchangeFileManagerIsNull = new()
    {
        Code = nameof(ExchangeFileManagerIsNull),
        Name = "exchangeFileManager is null in UpdateProgramWithParameters"
    };

    public static readonly Error FileNameIsEmpty = new()
    {
        Code = nameof(FileNameIsEmpty), Name = "File name is empty"
    };

    public static readonly Error FolderNameIsEmpty = new()
    {
        Code = nameof(FolderNameIsEmpty), Name = "Folder name is empty"
    };
    ...
    {
        return new Error { Code = nameof(CannotRegisterService), Name = $"cannot register Service {serviceEnvName}" };
    }
    ...
    {
        return new Error { Code = nameof(FolderCanNotBeDeleted), Name = $"Folder {folderName} can not be Deleted" };
    }
    ...
    public static Error ProjectInstallerFolderIsNotExists(string folderName)
    {
        return new Error
        {
            Code = nameof(ProjectInstallerFolderIsNotExists),
    ...
    public static Error ServiceIsRunningAndCannotBeUpdated(string serviceEnvName)
    {
        return new Error
        {
            Code = nameof(ServiceIsRunningAndCannotBeUpdated),
